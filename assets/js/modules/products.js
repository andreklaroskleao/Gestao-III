      ...
      <tr>
        ...
        <td>
          <div class="inline-row">
            ...
            <button class="btn btn-secondary" data-product-move="${product.id}">Movimentar</button>
    ...
    tabEls.products.innerHTML = `
      <div class="products-layout">
        <div class="panel">
          <div class="section-header">
            <h2>${state.editingProductId ? 'Editar produto' : 'Cadastro de produtos'}</h2>
            <span class="muted">Otimizado para celular e desktop</span>
          </div>
          ...
          <div class="table-wrap" style="margin-top:14px;">
            <table>
              ...
              <tbody id="products-tbody">
                ${rows || '<tr><td colspan="9">Nenhum produto cadastrado.</td></tr>'}
              </tbody>
            </table>
          </div>
        </div>
      ...
      <div class="table-card" style="margin-top:18px;">
        ...
        <div class="search-row" style="margin-bottom:14px; flex-wrap:wrap;">
          ...
          <button class="btn btn-secondary" id="movement-filter-apply">Filtrar</button>
          <button class="btn btn-secondary" id="movement-filter-clear">Limpar</button>
        </div>
