const CACHE_NAME = 'gestao-comercial-v1';
const APP_ASSETS = ['./','./index.html','./manifest.webmanifest','./assets/css/style.css','./assets/css/theme-additions.css','./assets/js/app.js'];
